...
-- CreateTable
CREATE TABLE "Userperferences" (
    "id" TEXT NOT NULL,
    "emailUpdates" BOOLEAN NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "Userperferences_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Userperferences_userId_key" ON "Userperferences"("userId");
...
-- AddForeignKey
ALTER TABLE "Userperferences" ADD CONSTRAINT "Userperferences_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
